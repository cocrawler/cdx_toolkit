...
async def get_range_jobs_from_athena(
    ...
    find the file names, offsets, and byte lengths for WARC filtering.

    See https://commoncrawl.org/blog/index-to-warc-files-and-urls-in-columnar-format

    This function queries Athena (AWS access required), puts a RangeJob
    (WARC files and offets) for each result and pushed them to the
    asyncio queue."""
    ...
    # TODO there should be more filteres (dates/crawls/...)
