...
def main(args=None):
    ...
    parser.add_argument('--limit', type=int, action='store')  # XXX default
    ...
    parser.add_argument('--get', action='store_true', help='use a single get instead of a paged iteration')
