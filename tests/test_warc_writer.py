...
@pytest.mark.parametrize(
    ...
    [
        ...
        # pytest.param("test-prefix-folder/file-prefix", None, id="Folder as prefix"),  # raised FileNotFound error (parent dir does not exist)
    ],
)
def test_write_to_local(prefix, gzip, tmpdir):
    ...
    writer.write_record(WARCWriter(None).create_warc_record(
            uri="foo/bar", 
